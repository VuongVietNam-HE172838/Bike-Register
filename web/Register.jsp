    ...
    <body>
        ...
        <section>
            <div id="banner-top" class="" style="pointer-events: none">
                <div class="carousel-banner-top-item">
                    <img class="owl-lazy" src="Image/1.jpg">
        ...
        <div class="login-default" style="align-items: center;">
            <form action="register" method="post">
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    <span class="input_label">Tên Đăng nhập</span>
                    <div class="input-group">
                        <input name="input-account" type="text" id="" class="form-control" placeholder="Nhập tên đăng nhập" required
                               value="${account}">
                    </div>
                </div>
                <p style="text-align: center; color: red; font-size: 14px; margin-bottom: 0;">
                        ${errorMessages["input-account"]}
                    </p>
